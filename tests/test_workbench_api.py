...
class WorkbenchApiTests(unittest.TestCase):
    ...
    def test_bundles_endpoint_exposes_quiet_enrichment_detail_fields(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(payload[0]["enrichment_status_reason"], "")
            ...
            self.assertEqual(payload[0]["bundle_path"], "20_Raw/inbox/quiet-detail")
    ...
    def test_bundles_endpoint_defaults_quiet_detail_fields_when_sidecar_is_missing(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("enrichment_entity_hints", payload[0])
            self.assertEqual(len(payload), 1)
            self.assertEqual(payload[0]["bundle_path"], "20_Raw/inbox/missing-sidecar")
